<template>
  <section class="bg-[#facc15] px-6 py-20">
    <div class="mx-auto max-w-4xl space-y-6 text-center">
      ...
      <p class="text-lg text-gray-800">
        Met AITJE werk je lokaal, houd je jouw data in eigen beheer en blijf je
        onafhankelijk van niet-Europese platformen. We laten je graag zien wat
        dat in de praktijk oplevert.
      </p>
