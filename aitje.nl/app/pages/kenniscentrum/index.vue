    ...
    <main class="px-6 pt-32">
      ...
      >
        ...
        <p class="mt-6 text-lg text-gray-600">
          Korte artikelen over AI termen die je vaak hoort rondom onze oplossing en terug ziet op de website.
        </p>
      </section>
          ...
          >
            ...
            <div class="p-6">
              ...
              <div class="mt-5 flex items-center justify-between text-sm">
                <span class="font-semibold text-[#facc15]">Lees artikel</span>
                <span
