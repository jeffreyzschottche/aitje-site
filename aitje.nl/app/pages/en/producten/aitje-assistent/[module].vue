  ...
  <div class="bg-[#f5f5f5] text-gray-900">
    ...
    <main v-if="moduleContent" class="px-6 pb-20 pt-32">
      <section class="mx-auto max-w-5xl rounded-[2.5rem] border border-gray-200 bg-white p-10">
        <NuxtLink
          to="/en/producten/aitje-assistent"
          class="text-sm font-semibold text-gray-500 transition hover:text-gray-900"
        >
          Back to AITJE Assistent
        </NuxtLink>
        <p class="mt-6 text-xs font-semibold uppercase tracking-[0.35em] text-[#facc15]">Part of AITJE Assistent</p>
...
const moduleContent = computed(() => productCatalogV2.en.assistantModules[moduleSlug.value]);
