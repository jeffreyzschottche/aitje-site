export const serviceCatalog = [
  {
    ...
    body: [
      "Product Installatie is bedoeld als praktische hulp, niet als verplichte stap. In de meeste gevallen kun je zelf starten met een AITJE-product. Toch kan het handig zijn dat wij meekijken wanneer er meerdere gebruikers, rechten, netwerkkeuzes of beheerafspraken spelen.",
      "We kunnen de inrichting op afstand doen, maar ook fysiek langskomen wanneer de omgeving daarom vraagt. Denk aan het koppelen van accounts, het nalopen van toegangsrechten, het controleren van lokale bereikbaarheid en het helpen structureren van bestaande kennisbronnen zodat je team direct met een logische basis werkt.",
    ],
    result:
  ...
  },
  {
    ...
    body: [
      "Product uitbreiding is voor situaties waarin de basis al werkt, maar de praktijk groter of specifieker wordt. Misschien komen er extra teams bij, moet een workflow anders worden ingericht of wil je bestaande onderdelen koppelen aan nieuwe processen.",
      "We kijken eerst naar wat er al staat, zodat uitbreiding geen tweede los systeem wordt. Daarna bepalen we wat technisch nodig is, welke keuzes later beheerbaar blijven en hoe de uitbreiding past bij het product dat je al gebruikt.",
    ],
    result:
    ...
    details: [
      ...
      "Begeleiding bij keuzes die op langere termijn houdbaar blijven",
    ],
  ...
  },
  {
    ...
    details: [
      ...
      "Praktische oplevering rond de workflow waarvoor nog geen standaardoplossing bestaat",
    ],
  ...
  },
  {
    ...
    body: [
      "Consultancy is geschikt wanneer je nog niet precies weet of lokale AI, edge AI of een AITJE-product logisch is. We kijken naar processen, bestaande tools, kosten, afhankelijkheden en de plekken waar AI nu al wordt gebruikt of juist blijft liggen.",
      "Het resultaat hoeft niet altijd een aankoop of maatwerktraject te zijn. Soms is het advies om iets simpeler te organiseren, eerst met bestaande tools te werken of juist alleen een klein onderdeel lokaal te maken. De waarde zit in een nuchtere keuze voordat er geld en tijd in techniek gaat.",
    ],
    result:
  ...
  },
  {
    ...
    body: [
      "De SLA is het samenwerkingscontract voor organisaties die niet alleen een product willen gebruiken, maar ook structureel iemand naast zich willen hebben. Daarin kunnen support, updates, gereserveerde tijd, strategisch meedenken en kennisbankwerk samenkomen.",
      "Het opzetten van een kennisbank doen we alleen via SLA, omdat kwaliteit niet stopt na de eerste upload. Bronnen veranderen, prioriteiten verschuiven en teams moeten weten hoe ze informatie goed blijven toevoegen. Je kunt het beheer zelf doen, wij kunnen het blijven bijhouden, of we spreken een tussenvorm af.",
    ],
    result:
